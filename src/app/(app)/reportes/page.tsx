...
function PackagingStockReport() {
    ...
    return (
        <Card>
            <AccordionItem value="packaging-stock">
                <AccordionTrigger className="p-6">
                    <div className="text-left">
...
function BinMaterialKardexReport() {
    ...
    return (
        <Card>
            <AccordionItem value="bin-kardex">
                 <AccordionTrigger className="p-6">
                    <div className="text-left">
...
function ReceptionLogReport() {
    ...
    return (
        <Card>
            <AccordionItem value="reception-log">
                <AccordionTrigger className="p-6">
                    <div className="text-left">
...
function OtherFruitStockReport() {
    ...
    return (
        <Card>
            <AccordionItem value="other-fruit-stock">
                <AccordionTrigger className="p-6">
                    <div className="text-left">
...
function OtherFruitKardexReport() {
    ...
    return (
        <Card>
            <AccordionItem value="other-fruit-kardex">
                <AccordionTrigger className="p-6">
                    <div className="text-left">
