...
Gestiona el inventario de bins y materiales de embalaje.
...
- **Pestaña Salidas**: Registra el retiro de materiales para un productor. También cuenta con el cálculo automático.
...
- **Lista de Solicitudes**: Muestra los despachos creados.
    - **Hacer Picking**: Para despachos "Pendiente de Picking". Abre una lista de todas las ubicaciones a visitar. El operador debe marcar cada una. Al confirmar, el stock se rebaja definitivamente y el despacho se marca como "Completado".
    - **Exportar**: Para despachos "Completados", permite descargar un CSV con el detalle.
...
- **Picking**: Confirma la salida física de los materiales/fruta, rebajando el stock.
...
- **Reportes Disponibles**: Stock de Bins, Stock de Embalajes, Kardex de Movimientos, Registro de Recepción, Stock por Ubicación, etc.
